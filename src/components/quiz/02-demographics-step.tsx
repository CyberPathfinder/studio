        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="font-bold text-lg flex items-center gap-2">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <button type="button" aria-label="More information about age input">
              ...
              <FormControl>
                <Input type="number" placeholder="Enter your age" {...field} className="text-center text-lg h-12" aria-label="Age input" />
              </FormControl>
              <div className="text-center h-4">
                <FormMessage />
              </div>
